...
document.addEventListener('DOMContentLoaded',function(){
    const SEMANAS =[
        {name:'Semana 1', href: "#sem1",src:"./imagenes/card1.jpg",h3:"Semana 1",p:"En esta primera semana queremos presentarte la modalidad del curso y las primeras herramientas que vas a usar como desarrollador web."},

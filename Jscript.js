...
document.addEventListener('DOMContentLoaded',function(){
    const SEMANAS =[                      /*aqui se cambia la imagen*/
        {name:'Semana 1', href: "#sem1",src:"./imagenes/inicio.gif",h3:"Semana 1",p:"En esta primera semana queremos presentarte la modalidad del curso y las primeras herramientas que vas a usar como desarrollador web."},
        {name:'Semana 2',href: "#sem2",src:"./imagenes/card2.jpeg",h3:"Semana 2",p:"En esta semana vas a profundizar en cómo dar estructura a una página web empleando la herramienta básica de HTML.Veremos sus distintas etiquetas y su uso."},
        {name:'Semana 3',href: "#sem3",src:"./imagenes/card3.jpeg",h3:"Semana 3",p:"La idea es que esta semana aprendas a aplicar reglas de estilo para lograr un mejor resultado visual en el contenido. Para lograr esto vamos a comenzar a trabajar con CSS."},
        {name:'Semana 4',href: "#sem4",src:"./imagenes/card4.jpeg",h3:"Semana 4",p:"Con Javascript (JS) comenzarás a ampliar las funcionalidades de una página web "},
        ];
